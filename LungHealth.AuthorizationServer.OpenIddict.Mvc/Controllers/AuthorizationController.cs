       ...
       //     _userManager = userManager;
        ...
        public async Task<IActionResult> Exchange()
        {
            ...
            if (request.IsClientCredentialsGrantType())
            {
                ...
                var displayName = await _applicationManager.GetDisplayNameAsync(request.ClientId, CancellationToken.None);
                // Add some claim, don't forget to add destination otherwise it won't be added to the access token.
                identity.AddClaim(ClaimTypes.NameIdentifier, displayName, OpenIddictConstants.Destinations.AccessToken);
